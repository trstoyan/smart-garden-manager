# 🌿 Smart Device Integration Guide (ESP32 / Raspberry Pi)
...
## 🛰️ Features Enabled via Devices
...
* Activate grow light if `light < 150` and time is between 6am–8pm
